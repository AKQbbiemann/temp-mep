...
class CreateOrUpdateProfileChange extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'comprehensive_load' => 'integer|min:0|max:100|load_sum:base_load,organisation_load,local_load',
            'base_load' => 'integer|min:0|max:100|load_sum:comprehensive_load,organisation_load,local_load',
            'organisation_load' => 'integer|min:0|max:100|load_sum:base_load,comprehensive_load,local_load',
            'local_load' => 'integer|min:0|max:100|load_sum:base_load,organisation_load,comprehensive_load',
